                ...
                <div class="relative p-6 transition-transform transform bg-white rounded-lg shadow-md dark:bg-gray-800 hover:scale-105 hover:shadow-xl product-card"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex justify-end space-x-2 mt-4">
                            <a href="{{ route('superviseur.produits.show', $produit) }}"
                            ...
                            <a href="{{ route('superviseur.produits.edit', $produit) }}"
                            ...
                            <button onclick="openModal('{{ route('superviseur.produits.destroy', $produit) }}')"
